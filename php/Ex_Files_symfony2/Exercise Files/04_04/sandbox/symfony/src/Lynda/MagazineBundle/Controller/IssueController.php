...
use Lynda\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LyndaMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("LyndaMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LyndaMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LyndaMagazineBundle:Issue:edit.html.twig")
     */
